                    ...
                    {label = "Ped Previews", type = "toggle", var = "pedPreviews"},
                    {
                        ...
                        action = function() 
                            Citizen.CreateThread(function()
                                ...
                                local timeout = GetGameTimer() + 10000 -- 10 sec timeout for bugged executors
                        ...
                        action = function()
                            if selectedPlayerId ~= -1 then
                                ...
                                if SpectateActive then
                                    ...
                                    SpectateTarget = nil
                                    Citizen.InvokeNative(0x423DE3854BB50894, false, PlayerPedId()) -- NetworkSetInSpectatorMode
    ...
    while true do
        ...
        if duiObj then
            ...
            if menuOpen and not isSearching then
                ...
                -- Up
                local upPressed = IsDisabledControlJustPressed(0, 172) or IsDisabledControlJustPressed(0, 188) or IsControlJustPressed(0, 188)
                local upHeld = IsDisabledControlPressed(0, 172) or IsDisabledControlPressed(0, 188) or IsControlPressed(0, 188)
                if upPressed then 
                    upDelay = 250 
                ...
                -- Down
                local downPressed = IsDisabledControlJustPressed(0, 173) or IsDisabledControlJustPressed(0, 187) or IsControlJustPressed(0, 187)
                local downHeld = IsDisabledControlPressed(0, 173) or IsDisabledControlPressed(0, 187) or IsControlPressed(0, 187)
                if downPressed then 
                    downDelay = 250 
                ...
                -- Item Value Left (Arrow Left is 174 or Frontend Left 189)
                if (IsDisabledControlJustPressed(0, 174) or IsDisabledControlJustPressed(0, 189) or IsControlJustPressed(0, 189)) and hasItems then
                    local item = activeTab.items[currentItemIdx]
                ...
                -- Item Value Right (Arrow Right is 175 or Frontend Right 190)
                if (IsDisabledControlJustPressed(0, 175) or IsDisabledControlJustPressed(0, 190) or IsControlJustPressed(0, 190)) and hasItems then
                    local item = activeTab.items[currentItemIdx]
                    if item.type == "slider" then
